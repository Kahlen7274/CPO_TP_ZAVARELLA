...
public class Partie {
    ...
    public void débuterPartie() {
        ...
        while ((plateau.etreGagnantePourCouleur("rouge") == false) && (plateau.grilleRemplie() == false) && (plateau.etreGagnantePourCouleur("jaune") == false)) {
            ...
            // cas ou on n'a plus de désintegrateur
            if (action == 2) {
            ...
            switch (action) {
                ...
                case 1 -> {
                    ...
                    if (plateau.Grille[i][col].presenceTrouNoir() == true) {
                        plateau.supprimerJeton(i,col);
                        plateau.suppprimerTrouNoir(i, col);
                ...
                case 2 -> {
                    ...
                    while (plateau.Grille[lig2][col2].lireCouleurDuJeton().equals(joueurCourant.couleur)) {
                    ...
                    plateau.afficherGrilleSurConsole();
                    joueurCourant.nombreDesintegrateurs--;
                    System.out.println("Nombre de désintégrateur : " + joueurCourant.nombreDesintegrateurs + "de " + joueurCourant);
                }
                ...
                case 3 -> {
                    ...
                    while (!plateau.Grille[lig3][col3].lireCouleurDuJeton().equals(joueurCourant.couleur)) {
            ...
            if (plateau.etreGagnantePourCouleur(J) == false) {
                ...
                System.out.println("Nombre de desintegrateur de " + joueurCourant.nom + " est : " + joueurCourant.nombreDesintegrateurs);
            }
            else{
               
            }
        }
        if (plateau.etreGagnantePourCouleur("rouge") == true) {
            System.out.println("\n" + ListeJoueurs[0] + " (Rouge) a gagne !");
            plateau.viderGrille(ListeJoueurs[0], ListeJoueurs[1]);
            //this.debuterPartie();
        }
        if (plateau.etreGagnantePourCouleur("Jaune") == true) {
